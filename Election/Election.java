...
public class Election implements ElectionInterface {
	...
	private HashMap<String, BST<String, Integer>> topk = new HashMap<>(); // <Constituency, BST<CandID, Votes>> for topk
																			// Constituency
	private HashMap<String, BST<String, Integer>> State = new HashMap<>(); // <State, BST<Party, Votes> for leading
																			// party
